...
public Map<String, Object> getStats(String campo, List<Object> lista) {
	...
	if(!lista.isEmpty()) {
		 // se il primo valore ̬ un numero crea una lista di numeri e gli passa i valori della lista castati a Number
		...
		// se il primo valore non ̬ un numero calcola le statistiche per le stringhe
		else {
